...
import { StudentArticleDetail } from '@/components/articles/student-article-detail';
...
export default function StudentArticleDetailPage({ params }: StudentArticleDetailPageProps) {
  const { id } = use(params);
  ...
  return <StudentArticleDetail article={article} sections={sections} />;
}