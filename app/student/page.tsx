                ...
                <CardHeader>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {quiz.questions_count || 0} questions • {quiz.questions_count || 0} minutes
                    </span>
                  </div>
                  <div className="text-xs text-muted-foreground">
                    Published: {new Date(quiz.published_at || quiz.created_at).toLocaleDateString()}
                  </div>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="text-right">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button size="sm" variant="outline" asChild>
                          <Link href={`/student/quiz-review/${quiz.id}`}>View Answers</Link>
                        </Button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <Button size="sm" variant="outline" className="mt-2" asChild>
                        <Link href={`/student/quiz-review/${quiz.id}`}>View Questions</Link>
                      </Button>
                    </div>
                  </div>
                </CardContent>
