...
import { FileText, Loader2, Presentation, Search, Filter, Grid, List } from 'lucide-react';
import Link from 'next/link';
import { EnhancedArticleList } from '@/components/articles/enhanced-article-list';
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <div className="flex gap-2">
            <Link href="/admin/articles/generate-presentation">
