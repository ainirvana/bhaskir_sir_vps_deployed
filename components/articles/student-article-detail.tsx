...
interface StudentArticleDetailProps {
  article: Article;
  sections: Section[];
}

export function StudentArticleDetail({ article, sections }: StudentArticleDetailProps) {
  return (
    <div className="container max-w-4xl mx-auto px-4 py-8">
      <Button variant="ghost" size="sm" className="mb-6" asChild>
        <Link href="/student/articles" className="flex items-center gap-1">
